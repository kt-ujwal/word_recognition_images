...
IM_WIDTH = 1280 # Setting camera constants
IM_HEIGHT = 720
...
from utils import label_map_util # Import utilites
from utils import visualization_utils as vis_util

MODEL_NAME = 'ssdlite_mobilenet_v2_coco_2018_05_09' # object detection module 
CWD_PATH = os.getcwd()
...
# dictionary mapping of integers to appropriate string labels
...
detection_scores = detection_graph.get_tensor_by_name('detection_scores:0')#confidence score
detection_classes = detection_graph.get_tensor_by_name('detection_classes:0')
num_detections = detection_graph.get_tensor_by_name('num_detections:0')# Number of objects detected

frame_rate_calc = 1# Frame rate
